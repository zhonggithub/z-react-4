...
class TagSelect extends Component {
  ...
  render() {
    ...
    const {
      children, hideCheckAll, className, style, expandable, actionsText = {},
    } = this.props;
    ...
    const tmpStyle = [];
    if (expandable) {
      tmpStyle.push('tagSelectExpandedHasExpandTag');
    }
    if (expand) {
      tmpStyle.push('tagSelectExpanded');
    }
    const cls = classNames('tagSelect', className, tmpStyle);
    return (
      <div className={cls} style={style}>
        ...
        {expandable && (
          <a className='tagSelectTrigger' onClick={this.handleExpand}>
